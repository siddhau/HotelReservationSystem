	...
	<tr>
	 ...
	 <%-- 	<%
		...
		{ 
			...
			<option value="Blue Diamond-SNG"></option>
			<option value="Blue Diamond-DBL"></option>
			<option value="12TH Avenue-SNG"></option>
			<option value="12TH Avenue-DBL"></option>
...
<center><input type="submit" value="addTheRoom" name="button" ></center>
<%
if(newSession!=null)
{
