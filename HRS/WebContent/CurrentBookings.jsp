...
<table border="1" align="center">
	...
	<%
	  ReservationBean rb;
		...
		ArrayList<ReservationBean> rbList = (ArrayList<ReservationBean>)session.getAttribute("currentBooking");
		...
		<tr>	
			...
			<td><%= rb.getNightNo()%></td>
			<td><input type="hidden" value="<%= i%>" name="cancelBooking"/><input type="submit" value="delete" name="button"></td>
			<td><input type="hidden" value="<%= i%>" name="extendBooking"/><input type="submit" value="extend" name="button"/></td> 
			</tr>
	<%
		i++;
		}
	%>
	<tr><input type="submit" value="Delete All" name="button"/></td></tr>
</table>
</form>
</body>
</html>